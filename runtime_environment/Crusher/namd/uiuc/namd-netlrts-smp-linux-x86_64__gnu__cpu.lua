...
-- runtime environment
charm_module = "Spock/charm++/" .. "netlrts-linux-x86_64-smp-gcc"
load(charm_module)
...
-- 
-- -------------------------------------------------
local prefix=pathJoin(os.getenv("NCP_TOP_LEVEL"),"sw",machine_name,"NAMD","UIUC",namd_arch_file,charm_arch,"cpu") 
...
--
-- -------------------------------------------------
setenv("NCP_TARGET_BUILD","namd-netlrts-linux-x86_64__gnu__cpu")
